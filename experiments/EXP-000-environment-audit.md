...
主样本 SHA-256：`55E98463B8E270F4E7D87BDA5D0EE73329880A96CF753FC2C78E1849F1C4AB17`。
...
`video-generation/seedance_api.txt` 包含单行敏感凭据。盘点过程中未显示或复制凭据。正式实现只允许通过环境变量读取；若凭据曾出现在仓库、聊天或日志中，应先轮换。
