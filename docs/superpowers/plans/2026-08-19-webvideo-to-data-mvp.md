...
- Do not install or alter software on `root@8.160.161.137:1007` in this plan.
...
Set source path `video/手机录制.mp4`, SHA-256 `55E98463B8E270F4E7D87BDA5D0EE73329880A96CF753FC2C78E1849F1C4AB17`, first-frame ROI `[374, 423, 104, 155]` in `[x,y,w,h]` pixels, 30 FPS, forward-backward threshold 1.5 px, minimum 8 live points, canonical scene bounds x `[-0.15,0.15]` m and y `[0.35,0.65]` m, B0 start `[0.12,0.45,0.04]` m, B0 goal `[-0.05,0.55,0.13]` m, and random seed 19. The ROI was fixed from frame 0 before any run and must not be tuned after reading success metrics.
